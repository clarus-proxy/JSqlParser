...
public interface StatementVisitor {
    ...
    void visit(StartTransaction startTransaction);

    void visit(Commit commit);

    void visit(Rollback Rollback);

    void visit(DeclareCursor declareCursor);

    void visit(CursorFetch cursorFetch);

    void visit(CursorMove cursorMove);

    void visit(CursorClose cursorClose);
}
